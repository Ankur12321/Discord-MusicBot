module.exports = {
  Admins: ["UserID", "836646337818394706"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "/", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", // Support Server Link
  Token: process.env.Token || "MTEyNDM4MDg5MDA0NzQ1OTQwOA.Gfpr0m.zYkDCFyK7PO1spGFyTSk8j7OYx1fD9dZSyxNS4", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1124380890047459408", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "jzRFuDWIqO1HXwp1lsbIyPhwnH5oRj78", // Discord Client Secret
  ...
  CookieSecret: "Pikachu is EPIC With Power", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "06c26cf2192d4d048824143ce384345a", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "e3dfe15091274e3c8b6365dba1abb984", // Spotify Client Secret
  },
};
